<template>
  <div class="relative">
    ...
    <transition name="fade-scale">
      <div
        v-if="showFilters"
        class="absolute top-full left-0 z-50 mt-2 w-64 h-72 overflow-y-auto rounded-lg bg-white dark:bg-[#212124] shadow-lg border dark:border-[#2a2a2d] transition-opacity duration-300"
      >
        <div
          class="p-3 border-b dark:border-[#2a2a2d] bg-gray-100 dark:bg-[#1a1a1d] text-sm font-semibold text-gray-800 dark:text-white"
        >
          Выберите фильтры
        </div>
